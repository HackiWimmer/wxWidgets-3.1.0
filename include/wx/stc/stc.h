...
/// Lexical state for GCODE
/* ADD_CODE_START */
#define wxSTC_GCODE_DEFAULT 0
#define wxSTC_GCODE_OPERATOR 1
#define wxSTC_GCODE_NUMBER 2
#define wxSTC_GCODE_IDENTIFIER 3
#define wxSTC_GCODE_PARAM 4
#define wxSTC_GCODE_COMMENT 5
#define wxSTC_GCODE_COMMENT_LINE 6
#define wxSTC_GCODE_BUF 7
#define wxSTC_GCODE_CMD 8
#define wxSTC_GCODE_MSG 9
#define wxSTC_GCODE_STRING 10
#define wxSTC_GCODE_DIRECTIVE 11
/* ADD_CODE_END */
